                    ...
                    <NoteBlock
                      ...
                      onChange={(edits) => {
                        ...
                        setCAPData((prevCAPData) => {
                          ...
                          let newCAPData = { ...prevCAPData };
                          let lineIndex = newCAPData.currentIssues[issueIndex][
                            section.name
                      ...
                      onDragToIssue={(
                        ...
                        // otherwise, add data to the issue =
                          ...
                          targetissueId = capData.currentIssues[issueIndex].id;
                        }
                        ...
                        setCAPData((prevCAPData) => {
                          ...
                          let issueIndex = newSoapData.currentIssues.findIndex(
                            (practice) => practice.id === issueId
                          );
                ...
                <>
                  ...
                  <div className="text-sm text-gray-700 italic mt-2">
                    ...
                    <div className="grid grid-cols-2 gap-y-1 w-2/3">
                      ...
                      <p>
                        w/[person, person]: person(s) who the practice should be
                        done with
                      </p>
                      <p>
